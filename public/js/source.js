                    ...
                    if(event[i].name == $('#search-text').val() || event[i].brand == $('#search-text').val()){
                      ...
                      $('#tbody').append(
                        `<tr>
                            ...
                            <td>${event[i].screensize}</td>
                            <td>
                                <button id="edt-${event[i].id}" class="tryedit btn btn-primary btn-sm">Edit</button>
                                <button id="del-${event[i].id}" class=" btn btn-danger btn-sm">Delete</button>
                            </td>
                        </tr>`
                      )
